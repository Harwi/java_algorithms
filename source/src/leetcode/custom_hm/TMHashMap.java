...
public class TMHashMap {
     ...
     *
     * This is also used as linked list in case multiple key-value leetcode.pairs lead to
    ...
    public static void main(String[] args) {
        ...
        Employee e1 = new Employee(99999999, "Niranjan");
        tmhm.put(e1, "dept1");
